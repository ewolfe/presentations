...
<CodeSurfer
  ...
  code={require("!raw-loader!./wishlist-1.js")}
  lang="jsx"
  showNumbers={true}
  dark={true}
  steps={[
...
<CodeSurfer
  ...
  code={require("!raw-loader!./wishlist-3.js")}
  lang="jsx"
  showNumbers={true}
  dark={true}
  steps={[
...
<br />
<br />
<img style={{ maxWidth: '25vw' }} src="https://github.com/ewolfe/raw/master/assets/logo.jpg" />
